...
__attribute__((noinline)) struct MHD_HTTP_Header * MHD_pool_allocate_header (struct MHD_Connection *connection)
// static struct MHD_HTTP_Header * MHD_pool_allocate_header (struct MHD_Connection *connection)
{
  return (struct MHD_HTTP_Header *) MHD_pool_allocate(connection->pool, sizeof (struct MHD_HTTP_Header), true);
}
                                     ...
                                     size_t value_size)
{
  ...
  pos = MHD_pool_allocate_header(connection);  
